...
すでに古くなってしまった情報などもありますが、当時のまま as is でGitHubに収録しています。
...
C#5.0編	| 27CSharp50 |  No369 - No379 |		async, awaitを中心にC#5.0で新たに追加された機能について解説。また、.NET Framework4.5のZipArcive、IReadOnlyCollection<T>についても解説。
